...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.startDate = moment("2016-01-01",'YYYY-MM-DD');
            this.endDate = moment().endOf('day');
            this.minDate = moment("2016-01-01",'YYYY-MM-DD');
        ...
        updateSpan : function(){
            document.getElementById(this.spanId).innerHTML = this.startDate.format('YYYY-MM-DD') + ' — ' +  this.endDate.format('YYYY-MM-DD');
        }
